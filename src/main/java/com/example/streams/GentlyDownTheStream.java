...
public class GentlyDownTheStream {
    ...
    public String commaSeparatedListOfFruits() throws InvalidDataException {
        try {
            ...
            throw new InvalidDataException("Failed to build comma separated fruit list: " + e.getMessage());
        }
    }
    ...
    public Double average() throws InvalidDataException {
        try {
            ...
            throw new InvalidDataException("Failed to calculate average: no numeric values");
        } catch (Exception e) {
